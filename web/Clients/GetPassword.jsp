                ...
                <div class="box_center">
                    <form action="/ClientUpdate.action" class="jqtransform" enctype="multipart/form-data" onsubmit="return toVaild()" method="post">
                        <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <input required hidden type="text" name="password_old" id="password_old" class="input-text lh30" size="40"
                            ...
                            <input required type="text" name="upPass" id="forget" class="input-text lh30" size="40"
